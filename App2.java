...
public class App2 {
    ...
    public static void main(String[] args) {
        ...
        final String colorGreen = "\033[0;32m",colorBlue = "\033[1;34m",colorPurple = "\033[0;35m",reset ="\033[0m",colorYellow = "\033[0;33m",GREEN_BACKGROUND = "\033[42m";
        ...
        do{
            ...
            String title = String.format("%s%s%s%s",colorBlue," ".repeat((60 - screen.length())/2),screen.toUpperCase(),reset);
            ...
            switch (screen){
                ...
                case Dashboard:
                    ...
                    switch(option){
                        ...
                        case 5 : screen = Ac_Bal;break;
                        case 6 : screen = Del_Ac;break;
                    ...
                    while(true){
                        ...
                        if(accName.isBlank()) {
                            ...
                            for (int i = 0; i < accName.length() ; i++) {
                                if(!(Character.isLetter(accName.toLowerCase().charAt(i)) || accName.charAt(i) == ' ')) {
                                    ...
                                    if(scanner.nextLine().strip().toUpperCase().equals("Y")) continue lblName;
                                    screen = Dashboard;
                                    break lblName;
                                }
                            }
                        ...
                        do{
                            ...
                            if(initDepo < 5000){
                                ...
                                else screen = Dashboard; break lblName;
                                
                            }else{
                                System.out.printf("Account number %s%s%s of %s\033[1;30m%s%s has been created\n",colorYellow,id,reset,GREEN_BACKGROUND,accName.toUpperCase(),reset);
                                break;
                            }
                        }while(true);
                        ...
                        if(scanner.nextLine().strip().toUpperCase().equals("Y")){
                            x++;
                            continue;
                        }else screen = Dashboard;break lblMain;
